...
impl MarketFilters {
    ...
    pub fn calculate_price_velocity(
        ...
        let window_prices: Vec<_> = recent_prices.iter()
...
mod tests {
    ...
    fn test_good_market_passes() {
        ...
        assert!(result.passed, "Good market should pass: {:?}", result.reasons);
    }
    ...
    fn test_low_depth_fails() {
        ...
        assert!(result.reasons.iter().any(|r| r.contains("Insufficient total depth")));
    }
    ...
    fn test_fast_price_movement_fails() {
        ...
        assert!(result.reasons.iter().any(|r| r.contains("Price moving too fast")));
    }
    ...
    fn test_high_latency_fails() {
        ...
        assert!(result.reasons.iter().any(|r| r.contains("Data latency too high")));
    }
    ...
    fn test_information_cascade_fails() {
        ...
        assert!(result.reasons.iter().any(|r| r.contains("information cascade")));
    }
