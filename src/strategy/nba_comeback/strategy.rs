...
impl NbaComebackMarketRegistration {
    fn matches_game(&self, game: &LiveGame) -> bool {
        self.game_id
            .as_deref()
...
impl NbaComebackStrategy {
    ...
    fn can_open_notional(&self, amount: Decimal) -> bool {
    ...
    fn release_pending_order(&mut self, client_order_id: &str) -> Option<PendingNbaComebackOrder> {
    ...
    fn build_actions_for_opportunity_inner(
        &mut self,
        opp: &ComebackOpportunity,
        condition_id: Option<String>,
        now: DateTime<Utc>,
