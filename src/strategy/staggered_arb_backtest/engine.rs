...
use ploy_backtest::strategies::StaggeredArbClosedTrade;

use super::display::print_staggered_summary as render_staggered_summary;
use super::state::{ActiveWindowInfo, ArbPositionState, StaggeredArbPosition};
...
impl StaggeredArbBacktestEngine {
    ...
    pub fn print_staggered_summary(&self) {
        render_staggered_summary(&self.closed_trades);
    }
}
// ─────────────────────────────────────────────────────────────
