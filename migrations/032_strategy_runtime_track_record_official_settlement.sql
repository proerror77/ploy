-- Migration: 032_strategy_runtime_track_record_official_settlement
...
normalized_fills AS (
    ...
    LEFT JOIN settlement_prices sp
        ON sp.event_id = f.event_id
       AND sp.token_id = f.token_id
),
aggregated AS (
    SELECT
        runtime_mode,
